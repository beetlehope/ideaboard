...
class IdeasContainer extends Component {
  ...
  componentDidMount(){
    axios.get('http://localhost:3808/api/v1/ideas.json')
    .then(response => {
  ...
  addNewIdea = () => {
     axios.post('http://localhost:3808/api/v1/ideas', {idea: {title: '', body: ''}})
    .then(response => {
  ...
  deleteIdea = (id) => {
    axios.delete(`http://localhost:3808/api/v1/ideas/${id}`)
    .then(response => {
